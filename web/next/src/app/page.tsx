      ...
      <header className="flex shrink-0 flex-col border-b border-[#1a1a1a] p-6 lg:p-8">
        <div className="flex items-start justify-between">
          <h1 className="flex items-baseline gap-2 font-serif leading-none font-bold tracking-tighter uppercase lg:gap-3">
            ...
            <span className="text-2xl lg:text-3xl">Studio</span>
          </h1>
        ...
        <div className="flex flex-col">
          ...
          <div className="grid min-h-[140px] flex-grow grid-cols-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex cursor-pointer flex-col items-start justify-center overflow-hidden border-r border-[#1a1a1a] bg-[#f8f7f2] p-6 hover:bg-[#1a1a1a] hover:text-[#ecebe5] lg:p-8"
            >
            ...
            <Link
              href="/studio"
              className="group relative flex cursor-pointer flex-col items-start justify-center overflow-hidden bg-[#1a1a1a] p-6 text-[#ecebe5] hover:bg-[#ecebe5] hover:text-[#1a1a1a] lg:p-8"
            >
              <div className="mb-2 flex items-center gap-2">
                <span className="font-mono text-xs tracking-widest uppercase opacity-60 group-hover:opacity-100">
                  Try It
              ...
              <h2 className="font-serif text-3xl font-bold tracking-tighter uppercase">
                Enter Studio
              </h2>
              <span className="absolute right-3 bottom-2 font-mono text-[9px] tracking-widest uppercase opacity-30">
                press enter
              </span>
            </Link>
          </div>
